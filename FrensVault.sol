...
contract FrensVault is ERC20, ERC20Detailed {
    ...
    constructor(address _token, address _controller)
        public
        ERC20Detailed(
            string(abi.encodePacked("FrensFi ", ERC20Detailed(_token).name())),
            string(abi.encodePacked("frens", ERC20Detailed(_token).symbol())),
